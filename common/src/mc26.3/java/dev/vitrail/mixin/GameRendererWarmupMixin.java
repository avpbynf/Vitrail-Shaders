 ...
 * still compiling.
 * <p>
 * The 26.3 half: the level is rendered by {@code renderLevel()} there, which reads the frame's time
 * off the game rather than taking it as an argument.
 */
...
public abstract class GameRendererWarmupMixin {
	...
	private void vitrail$skipLevelWhilePackWarms(GameRenderer renderer, Operation<Void> original) {
