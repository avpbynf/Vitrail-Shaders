package dev.vitrail.uniform.expr.kroppeb.stareval.resolver;
...
import dev.vitrail.uniform.expr.kroppeb.stareval.expression.CallExpression;
...
public class ExpressionResolver {
	...
	private final Map<String, ConstantExpression> numbers = new LinkedHashMap<>();
