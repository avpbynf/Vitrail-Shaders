...
import dev.vitrail.uniform.expr.kroppeb.stareval.element.Element;
...
import dev.vitrail.uniform.expr.kroppeb.stareval.element.token.BinaryOperatorToken;
import dev.vitrail.uniform.expr.kroppeb.stareval.element.token.IdToken;
import dev.vitrail.uniform.expr.kroppeb.stareval.element.token.NumberToken;
import dev.vitrail.uniform.expr.kroppeb.stareval.element.token.UnaryOperatorToken;
